...
if((i < len)){
var k = (ks[i]);
var G__5890 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__5891 = (i + (1));
m = G__5890;
i = G__5891;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__5892 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__5892) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__5892));
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__5894 = c;
var G__5894__$1 = (((G__5894 == null))?null:G__5894.prototype);
if((G__5894__$1 == null)){
return null;
} else {
return (G__5894__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__5896 = c;
var G__5896__$1 = (((G__5896 == null))?null:G__5896.prototype);
if((G__5896__$1 == null)){
return null;
} else {
return (G__5896__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__5900__delegate = function (args){
var G__5898 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__5898) : reagent.impl.component.as_element.call(null,G__5898));
};
var G__5900 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__5901__i = 0, G__5901__a = new Array(arguments.length -  0);
while (G__5901__i < G__5901__a.length) {G__5901__a[G__5901__i] = arguments[G__5901__i + 0]; ++G__5901__i;}
  args = new cljs.core.IndexedSeq(G__5901__a,0,null);
} 
return G__5900__delegate.call(this,args);};
G__5900.cljs$lang$maxFixedArity = 0;
G__5900.cljs$lang$applyTo = (function (arglist__5902){
var args = cljs.core.seq(arglist__5902);
return G__5900__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__5904 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__5905 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__5905;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__5904;
}});
...
var G__5906 = key;
var G__5906__$1 = (((G__5906 instanceof cljs.core.Keyword))?G__5906.fqn:null);
switch (G__5906__$1) {
...
return ((function (G__5906,G__5906__$1){
...
var c = this;
var G__5911_5913 = (c["cljsRatom"]);
if((G__5911_5913 == null)){
} else {
reagent.ratom.dispose_BANG_(G__5911_5913);
}
...
var renders_5915 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_5916 = cljs.core.first(cljs.core.vals(renders_5915));
if((cljs.core.count(renders_5915) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_5915))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_5916)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_5916], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__5914 = name;
switch (G__5914) {
case "":
...
var G__5919 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__5919) : reagent.impl.component.global$module$create_react_class.call(null,G__5919));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__5920 = fiber;
var G__5920__$1 = (((G__5920 == null))?null:(G__5920["type"]));
if((G__5920__$1 == null)){
return null;
} else {
return (G__5920__$1["displayName"]);
}
})();
var parent = (function (){var G__5921 = fiber;
if((G__5921 == null)){
return null;
} else {
return (G__5921["return"]);
}
})();
var path = (function (){var G__5922 = parent;
var G__5922__$1 = (((G__5922 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__5922) : reagent.impl.component.fiber_component_path.call(null,G__5922)));
if((G__5922__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__5922__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__4131__auto__ = (function (){var G__5924 = c;
if((G__5924 == null)){
return null;
} else {
return (G__5924["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__5925._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__5927 = c;
if((G__5927 == null)){
return null;
} else {
return (G__5927["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__5929 = c;
if((G__5929 == null)){
return null;
} else {
return G__5929._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__5931 = instance;
if((G__5931 == null)){
return null;
} else {
return (G__5931["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__5932 = instance;
if((G__5932 == null)){
return null;
} else {
return G__5932._currentElement;
}
}
})();
var name = (function (){var G__5933 = elem;
var G__5933__$1 = (((G__5933 == null))?null:(G__5933["type"]));
if((G__5933__$1 == null)){
return null;
} else {
return (G__5933__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__5935 = elem;
if((G__5935 == null)){
return null;
} else {
return (G__5935["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__5936._owner;
}
}
})();
var path = (function (){var G__5937 = owner;
var G__5937__$1 = (((G__5937 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__5937) : reagent.impl.component.component_path.call(null,G__5937)));
if((G__5937__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__5937__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__5938 = c;
var G__5938__$1 = (((G__5938 == null))?null:G__5938.constructor);
if((G__5938__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__5938__$1);
}
}
})();
