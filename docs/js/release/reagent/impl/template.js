...
var G__6034 = o;
(G__6034[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__6038 = o;
(G__6038[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__6039__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__6039 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__6040__i = 0, G__6040__a = new Array(arguments.length -  0);
while (G__6040__i < G__6040__a.length) {G__6040__a[G__6040__i] = arguments[G__6040__i + 0]; ++G__6040__i;}
  args = new cljs.core.IndexedSeq(G__6040__a,0,null);
} 
return G__6039__delegate.call(this,args);};
G__6039.cljs$lang$maxFixedArity = 0;
G__6039.cljs$lang$applyTo = (function (arglist__6041){
var args = cljs.core.seq(arglist__6041);
return G__6039__delegate(args);
});
...
var G__6043 = props;
var G__6043__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__6043,cljs.core.cst$kw$id,id):G__6043);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__6043__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__6044){
var map__6045 = p__6044;
...
var props = map__6045__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6045__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__6045,map__6045__$1,props,class$){
return (function (c){
...
});})(map__6045,map__6045__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__6047){
var map__6048 = p__6047;
var map__6048__$1 = (((((!((map__6048 == null))))?(((((map__6048.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6048.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__6048):map__6048);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6048__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__6048,map__6048__$1,on_write){
return (function (){
...
});})(node_value,map__6048,map__6048__$1,on_write))
);
} else {
...
var G__6051 = jsprops;
(G__6051["defaultValue"] = value);

(G__6051["onChange"] = ((function (G__6051,v,value,on_change){
return (function (p1__6050_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__6050_SHARP_);
});})(G__6051,v,value,on_change))
);
...
var vec__6054 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6054,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6054,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6054,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___6058 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___6058 == null)){
} else {
var key_6059 = temp__5461__auto___6058;
(jsprops["key"] = key_6059);
}
...
var temp__5461__auto___6060 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___6060 == null)){
} else {
var key_6061 = temp__5461__auto___6060;
reagent.impl.template.oset(jsprops,"key",key_6061);
}
...
var G__6062 = reagent.impl.template.__GT_NativeWrapper();
(G__6062["name"] = c);
...
var G__6063 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__6063) : reagent.impl.template.as_element.call(null,G__6063));
} else {
...
var len__4730__auto___6069 = arguments.length;
var i__4731__auto___6070 = (0);
while(true){
if((i__4731__auto___6070 < len__4730__auto___6069)){
args__4736__auto__.push((arguments[i__4731__auto___6070]));

var G__6071 = (i__4731__auto___6070 + (1));
i__4731__auto___6070 = G__6071;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq6067){
var G__6068 = cljs.core.first(seq6067);
var seq6067__$1 = cljs.core.next(seq6067);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__6068,seq6067__$1);
});
...
break;
default:
var G__6074 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__6074;
continue;
...
var n__4607__auto___6076 = a.length;
var i_6077 = (0);
while(true){
if((i_6077 < n__4607__auto___6076)){
(a[i_6077] = reagent.impl.template.as_element((a[i_6077])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___6079 = a.length;
var i_6080 = (0);
while(true){
if((i_6080 < n__4607__auto___6079)){
var val_6081 = (a[i_6080]);
if(((cljs.core.vector_QMARK_(val_6081)) && ((reagent.impl.template.key_from_vec(val_6081) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_6080] = reagent.impl.template.as_element(val_6081));
...
var ctx = ({});
var vec__6083 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6083,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6083,(1),null);
...
var G__6086 = (cljs.core.count(argv) - first_child);
switch (G__6086) {
case (0):
...
var G__6087 = comp;
var G__6088 = jsprops;
var G__6089 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__6087,G__6088,G__6089) : reagent.impl.template.global$module$react.createElement.call(null,G__6087,G__6088,G__6089));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__6086){
